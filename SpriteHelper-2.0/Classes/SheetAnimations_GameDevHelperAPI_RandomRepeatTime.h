...
#ifndef __SpriteHelper2_TestCases__SheetAnimations_GameDevHelperAPI_RandomRepeatTime__
#define __SpriteHelper2_TestCases__SheetAnimations_GameDevHelperAPI_RandomRepeatTime__


#include "cocos2d.h"
#include "TestLayer.h"
#include "GameDevHelper.h"
class SheetAnimations_GameDevHelperAPI_RandomRepeatTime : public TestLayer, public GHAnimationDelegate
{
public:
	SheetAnimations_GameDevHelperAPI_RandomRepeatTime();
	virtual ~SheetAnimations_GameDevHelperAPI_RandomRepeatTime();
    
	// there's no 'id' in cpp, so we recommand to return the exactly class pointer
	static cocos2d::CCScene* scene();
    
	// implement the "static node()" method manually
	CREATE_FUNC(SheetAnimations_GameDevHelperAPI_RandomRepeatTime);
...
#endif /* defined(__SpriteHelper2_TestCases__SheetAnimations_GameDevHelperAPI_RandomRepeatTime__) */
